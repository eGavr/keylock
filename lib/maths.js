...
///
exports.isAppropriateCorrelation = function(correlationBetweenRhythmograms, correlationBetweenFrequencyStats) {
    if(correlationBetweenRhythmograms >= 0.9) return true;

    if(correlationBetweenRhythmograms >= 0.7 && correlationBetweenFrequencyStats >= 0.8) return true;

    for(var i = 0.6, j = 1; i < 0.8; i += 0.01, j -= 0.01) {
        if(correlationBetweenRhythmograms >= i && correlationBetweenFrequencyStats >= j) return true;
    }
