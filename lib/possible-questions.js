...
///
exports.showLearningCharts = {
    type: 'list',
    name: 'showLearningCharts',
    message: 'Would you like to see the learning charts',
    choices: ['Yes', 'No'],
    filter: toLowerCase
};

exports.showApplyingCharts = {
    type: 'list',
    name: 'showApplyingCharts',
    message: 'Would you like to see the applying charts',
    choices: ['Yes', 'No'],
    filter: toLowerCase
};
