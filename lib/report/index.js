...
exports.learning = function(stats) {
    var login = stats.getLogin(),
        ...
        configs = getConfigsForCharts([{
            ...
            opts: {options: {title: {text: 'Average speed dependency'}}}
        }, {
            type: LineChart,
            ...
            opts: {options: {title: {text: 'Average rhythmogram'}}}
        }, {
            type: BarChart,
            data: stats.getBarStatsForRhythmogram(50),
            opts: {options: {title: {text: 'Frequency bar chart for rhythmogram'}}}
        }, {
            type: BarChart,
            data: stats.getAverageBarStatsForRhythmogram(50),
            opts: {options: {title: {text: 'Average frequency bar chart for rhythmogram'}}}
        }, /*{
            type: BarChart,
            data: stats.getFilteredBarStatsForRhythmogram(50),
            opts: {options: {title: {text: 'Filtered frequency bar chart for rhythmogram'}}}
        }, {
            type: BarChart,
            data: stats.getAverageFilteredBarStatsForRhythmogram(50),
            opts: {options: {title: {text: 'Average filtered frequency bar chart for rhythmogram'}}}
        },*/ {
            type: LineChart,
            data: stats.getBarStatsForRhythmogram(50),
            opts: {options: {title: {text: 'Frequency line chart for rhythmogram'}}}
        }, {
            type: LineChart,
            data: stats.getAverageBarStatsForRhythmogram(50),
            opts: {options: {title: {text: 'Average frequency line chart for rhythmogram'}}}
        }, /*{
            type: LineChart,
            data: stats.getFilteredBarStatsForRhythmogram(50),
            opts: {options: {title: {text: 'Filtered frequency line chart for rhythmogram'}}}
        }, {
            type: LineChart,
            data: stats.getAverageFilteredBarStatsForRhythmogram(50),
            opts: {options: {title: {text: 'Average filtered frequency line chart for rhythmogram'}}}
        }*/]);
