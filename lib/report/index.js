...
exports.learning = function(stats) {
    var login = stats.getLogin(),
        ...
        configs = getConfigsForCharts([{
            ...
            opts: {
                options: {title: {text: 'Average filtered frequency bar chart for rhythmogram'}},
                datasetsOptions: {labels: ['average']}
            }
        }, /*{
            type: LineChart,
            ...
            data: stats.getAverageFilteredBarStatsForRhythmogram(50),
            opts: {
                options: {title: {text: 'Average filtered frequency line chart for rhythmogram'}},
                datasetsOptions: {labels: ['average']}
            }
        }*/]);
...
exports.applying = function(stats) {
    var login = stats.getLogin(),
        ...
        configs = getConfigsForCharts([{
            ...
            data: stats.getFilteredBarStatsForRhythmogram(50),
            opts: {
                options: {title: {text: 'Filtered frequency line chart for rhythmogram'}},
                datasetsOptions: {labels: ['learning', 'applying']}
            }
        }*/]);
